package com.acc.core.utils;

import com.acc.core.annotation.Excel;
import com.acc.core.annotation.Excel.ColumnType;
import com.acc.core.annotation.Excel.Type;
import com.acc.core.annotation.ExcelHandlerAdapter;
import com.acc.core.annotation.Excels;
import com.acc.core.config.AccConfig;
import com.acc.core.exception.user.UtilException;
...
public class ExcelUtil<T> {
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = AccConfig.getDownloadPath() + filename;
