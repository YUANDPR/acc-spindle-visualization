...
import com.acc.system.utils.ShiroUtils;
...
public class KickoutSessionFilter extends AccessControlFilter {
    ...
    private boolean isAjaxResponse(ServletRequest request, ServletResponse response) throws IOException {
        ...
        if (ServletUtils.isAjaxRequest((javax.servlet.http.HttpServletRequest) req)) {
            AjaxResult ajaxResult = AjaxResult.error("您已在别处登录，请您修改密码或重新登录");
            ServletUtils.renderString((javax.servlet.http.HttpServletResponse) res, objectMapper.writeValueAsString(ajaxResult));
        } else {
