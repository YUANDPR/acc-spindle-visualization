package com.acc.system.config;

import at.pollux.thymeleaf.shiro.dialect.ShiroDialect;
import com.acc.constant.Constants;
import com.acc.properties.PermitAllUrlProperties;
import com.acc.system.filter.*;
import com.acc.system.realm.UserRealm;
import com.acc.system.session.*;
import com.acc.system.utils.CipherUtils;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
        ...
        // 对安卓登录请求放行
        filterChainDefinitionMap.put("/android/login", "anon");
        // 注册相关
